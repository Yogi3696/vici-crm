                    ...
                    <form action="{{ route('leads.import.preview') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="status" id="status" maxlength="6"
                                       class="form-control" value="{{ old('status', 'NEW') }}">
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <ol class="text-secondary small ps-3 mb-0">
                        ...
                        <li>{{ __('Rows with no phone number are skipped and reported back.') }}</li>
                    </ol>
                </div>
            </div>
        </div>
